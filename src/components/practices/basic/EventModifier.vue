...
<template>
  <div @click.self="handleBox2" class="practice-section">
    <h2>이벤트 수식어(Modifiers) 학습</h2>
    <h2>빈 공간은 self 작동</h2>
    <h3>1) .prevent (기본 동작 막기)</h3>
    <a href="www.naver.com" @click.prevent="handleLink">네이버 링크</a>
    <br />
    ...
    <div @click="handleBox" style="padding: 20px; background-color: #eee">
      ...
      <button @click.once.stop="handleChild3">한번만 나오는 버튼</button>
    </div>
  </div>
</template>
